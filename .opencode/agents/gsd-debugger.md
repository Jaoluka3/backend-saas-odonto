...
<required_reading>
@/root/meu-backend/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/root/meu-backend/.opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /root/meu-backend/.opencode
                  → checks /root/meu-backend/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /root/meu-backend/.opencode/get-shit-done
                  → writes to /root/meu-backend/.opencode/get-shit-done/hooks/
...
@/root/meu-backend/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @/root/meu-backend/.opencode/get-shit-done/references/common-bug-patterns.md

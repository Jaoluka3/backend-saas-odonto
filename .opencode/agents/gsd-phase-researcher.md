...
@/root/meu-backend/.opencode/get-shit-done/references/thinking-models-research.md
...
```bash
node "/root/meu-backend/.opencode/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```

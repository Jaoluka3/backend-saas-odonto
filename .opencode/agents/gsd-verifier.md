...
<required_reading>
@/root/meu-backend/.opencode/get-shit-done/references/verification-overrides.md
...
@/root/meu-backend/.opencode/get-shit-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@/root/meu-backend/.opencode/get-shit-done/references/few-shot-examples/verifier.md

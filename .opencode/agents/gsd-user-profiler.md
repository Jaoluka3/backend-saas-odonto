...
<reference>
@/root/meu-backend/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/root/meu-backend/.opencode/get-shit-done/references/user-profiling.md` to load:

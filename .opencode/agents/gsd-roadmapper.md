...
Reference full template: `/root/meu-backend/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/root/meu-backend/.opencode/get-shit-done/templates/state.md`.

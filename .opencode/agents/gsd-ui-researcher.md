...
Use template from `/root/meu-backend/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/root/meu-backend/.opencode/get-shit-done/templates/UI-SPEC.md`

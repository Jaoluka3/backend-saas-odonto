...
@/root/meu-backend/.opencode/get-shit-done/references/mandatory-initial-read.md
...
**Project skills:** @/root/meu-backend/.opencode/get-shit-done/references/project-skills-discovery.md
...
@/root/meu-backend/.opencode/get-shit-done/references/planner-source-audit.md for full format, examples, and gap-handling rules.
...
@/root/meu-backend/.opencode/get-shit-done/references/planner-source-audit.md for constraint examples.
...
**Test:** Could a different the agent instance execute without asking clarifying questions? If not, add specificity. See @/root/meu-backend/.opencode/get-shit-done/references/planner-antipatterns.md for vague-vs-specific comparison table.

## TDD Detection

**When `workflow.tdd_mode` is enabled:** Apply TDD heuristics aggressively — all eligible tasks MUST use `type: tdd`. Read @/root/meu-backend/.opencode/get-shit-done/references/tdd.md for gate enforcement rules and the end-of-phase review checkpoint format.
...
<execution_context>
@/root/meu-backend/.opencode/get-shit-done/workflows/execute-plan.md
@/root/meu-backend/.opencode/get-shit-done/templates/summary.md
</execution_context>
...
@/root/meu-backend/.opencode/get-shit-done/references/planner-antipatterns.md
...
```bash
node "/root/meu-backend/.opencode/get-shit-done/bin/gsd-tools.cjs" graphify status
```
...
```bash
node "/root/meu-backend/.opencode/get-shit-done/bin/gsd-tools.cjs" graphify query "<phase-goal-keyword>" --budget 2000
```
...
@/root/meu-backend/.opencode/get-shit-done/references/thinking-models-planning.md
...
See @/root/meu-backend/.opencode/get-shit-done/references/planner-chunked.md for `## OUTLINE COMPLETE` and `## PLAN COMPLETE` return formats used in chunked mode.

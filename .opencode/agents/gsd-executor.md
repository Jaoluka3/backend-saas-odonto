...
@/root/meu-backend/.opencode/get-shit-done/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/root/meu-backend/.opencode/get-shit-done/references/ios-scaffold.md
...
@/root/meu-backend/.opencode/get-shit-done/references/executor-examples.md
</deviation_rules>
...
**See @/root/meu-backend/.opencode/get-shit-done/references/checkpoints.md**
...
**Use template:** @/root/meu-backend/.opencode/get-shit-done/templates/summary.md

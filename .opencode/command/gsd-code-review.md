...
<execution_context>
@/root/meu-backend/.opencode/get-shit-done/workflows/code-review.md
</execution_context>
...
Execute the code-review workflow from @/root/meu-backend/.opencode/get-shit-done/workflows/code-review.md end-to-end.

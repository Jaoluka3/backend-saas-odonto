...
<execution_context>
@/root/meu-backend/.opencode/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/root/meu-backend/.opencode/get-shit-done/workflows/forensics.md end-to-end.
</process>

...
<execution_context>
@/root/meu-backend/.opencode/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/root/meu-backend/.opencode/get-shit-done/workflows/docs-update.md end-to-end.

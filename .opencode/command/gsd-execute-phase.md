...
<execution_context>
@/root/meu-backend/.opencode/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @/root/meu-backend/.opencode/get-shit-done/workflows/execute-phase.md end-to-end.

...
<execution_context>
@/root/meu-backend/.opencode/get-shit-done/workflows/spike.md
@/root/meu-backend/.opencode/get-shit-done/workflows/spike-wrap-up.md
...
- If it is `--wrap-up`: strip the flag, execute the spike-wrap-up workflow from @/root/meu-backend/.opencode/get-shit-done/workflows/spike-wrap-up.md.
- Otherwise: pass all of $ARGUMENTS as the idea to the spike workflow from @/root/meu-backend/.opencode/get-shit-done/workflows/spike.md end-to-end.

...
<execution_context>
@/root/meu-backend/.opencode/get-shit-done/workflows/update.md
</execution_context>
...
- Otherwise: **Follow the update workflow** from `@/root/meu-backend/.opencode/get-shit-done/workflows/update.md`.
...
@/root/meu-backend/.opencode/get-shit-done/workflows/sync-skills.md
@/root/meu-backend/.opencode/get-shit-done/workflows/reapply-patches.md
</execution_context_extended>

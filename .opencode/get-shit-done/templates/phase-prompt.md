...
<!-- For checkpoint task examples and patterns, see @/root/meu-backend/.opencode/get-shit-done/references/checkpoints.md -->
...
See `/root/meu-backend/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/root/meu-backend/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/root/meu-backend/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.

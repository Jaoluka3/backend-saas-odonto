...
- Usage: Reference from command with `@/root/meu-backend/.opencode/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /root/meu-backend/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /root/meu-backend/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

...
```
Task(
  prompt="Read /root/meu-backend/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/root/meu-backend/.opencode/get-shit-done/templates/SECURITY.md`

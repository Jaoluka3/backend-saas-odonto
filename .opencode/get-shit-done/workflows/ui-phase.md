...
```markdown
Read /root/meu-backend/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /root/meu-backend/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /root/meu-backend/.opencode/agents/gsd-ui-checker.md for instructions.

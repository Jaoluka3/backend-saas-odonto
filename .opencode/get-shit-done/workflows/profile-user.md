...
Key references:
- @/root/meu-backend/.opencode/get-shit-done/references/ui-brand.md (display patterns)
- @/root/meu-backend/.opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/root/meu-backend/.opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/root/meu-backend/.opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/root/meu-backend/.opencode/get-shit-done/USER-PROFILE.md" "/root/meu-backend/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /root/meu-backend/.opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/root/meu-backend/.opencode/get-shit-done/references/user-profiling.md`
...
Reference: @/root/meu-backend/.opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /root/meu-backend/.opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /root/meu-backend/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /root/meu-backend/.opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /root/meu-backend/.opencode/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /root/meu-backend/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/root/meu-backend/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /root/meu-backend/.opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /root/meu-backend/.opencode/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /root/meu-backend/.opencode/AGENTS.md
```

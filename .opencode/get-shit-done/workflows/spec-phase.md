...
```bash
INIT=$(node "/root/meu-backend/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/root/meu-backend/.opencode/get-shit-done/templates/spec.md.

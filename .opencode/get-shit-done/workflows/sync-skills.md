...
INSTALL_JS_GLOBAL="/root/meu-backend/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /root/meu-backend/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.

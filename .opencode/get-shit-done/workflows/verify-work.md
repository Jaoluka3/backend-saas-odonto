...
Read and follow `/root/meu-backend/.opencode/get-shit-done/workflows/transition.md`.
...
- Follow @/root/meu-backend/.opencode/get-shit-done/workflows/diagnose-issues.md

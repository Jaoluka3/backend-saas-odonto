...
See /root/meu-backend/.opencode/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /root/meu-backend/.opencode/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /root/meu-backend/.opencode/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /root/meu-backend/.opencode/get-shit-done/templates/discovery.md
...
Use /root/meu-backend/.opencode/get-shit-done/templates/discovery.md.

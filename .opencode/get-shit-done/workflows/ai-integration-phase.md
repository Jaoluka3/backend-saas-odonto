...
<required_reading>
@/root/meu-backend/.opencode/get-shit-done/references/ai-frameworks.md
@/root/meu-backend/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /root/meu-backend/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/root/meu-backend/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /root/meu-backend/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /root/meu-backend/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /root/meu-backend/.opencode/agents/gsd-eval-planner.md for instructions.
